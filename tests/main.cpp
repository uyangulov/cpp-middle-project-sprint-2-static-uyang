...
static void check_4()
{
    ...
    constexpr auto res =
        stdx::scan<format, in, int8_t, volatile uint8_t, const volatile int64_t,
...
static void check_int16_min_and_max()
{
    ...
    static_assert(std::get<0>(res.results) ==
                  std::numeric_limits<int16_t>::min());
    static_assert(std::get<1>(res.results) ==
...
{
    constexpr auto format = "{%d}_{%d}"_fs;
    constexpr stdx::details::fixed_string input =
        "-9223372036854775808_9223372036854775807";
...
static void check_uint64_some_intermediate_value()
{
    ...
    constexpr stdx::details::fixed_string input =
        "9223372036854775807_foooo_1234567890";
    constexpr auto res = stdx::scan<format, input, uint64_t, uint64_t>();
